...
from utils import guess_backlight_device
...
keys = [
    ...
    # Key([], "XF86MonBrightnessDown", lazy.spawn("brightnessctl -s set 10%-"))l
...
groups = [
    ...
    Group(name="d", screen_affinity=2),
]
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                # sep,
                widget.Backlight(
                    backlight_name = guess_backlight_device(),
